...
export enum CLIENT_TYPES {
  ...
  SOY_FOTÓGRAFX = "SOY FOTÓGRAFX/FILMMAKER",
  SOY_PROD = "SOY PRODUCER",
...
> = {
  ...
  [CLIENT_TYPES.SOY_AGENCIA]: [
    { label: "NOMBRE DE LA PERSONA DE CONTACTO*", type: "text" },
    {
      label: "CARGO DE LA PERSONA DE CONTACTO*",
      type: "dropdown",
      options: ["Producer", "Director", "Marketing", "Otros"],
    },
    { label: "NOMBRE DE LA AGENCIA/PRODUCTORA*", type: "text" },
    { label: "NOMBRE DE PROYECTO/MARCA*", type: "text" },
    { label: "CORREO ELECTRÓNICO*", type: "email" },
    { label: "TELÉFONO*", type: "tel" },
  ],
  [CLIENT_TYPES.SOY_FOTÓGRAFX]: [
    { label: "NOMBRE Y APELLIDO*", type: "text" },
    {
      label: "FOTÓGRAFX O FILMAKER*",
      type: "dropdown",
      options: ["Fotógrafx", "Filmmaker"],
    },
    {
  ...
  [CLIENT_TYPES.SOY_PROD]: [
    { label: "NOMBRE Y APELLIDO*", type: "text" },
    {
      label: "AGENCIA/PRODUCTORA/FREELANCE*",
      type: "dropdown",
      options: ["Agencia", "Productora", "Freelance", "Otros"],
    },
    { label: "NOMBRE DEL PROYECTO/MARCA*", type: "text" },
    { label: "CORREO ELECTRÓNICO*", type: "email" },
    { label: "TELÉFONO*", type: "tel" },
    { label: "INSTA DEL FOTÓGRAFX/FILMAKER*", type: "text" },
  ],
  [CLIENT_TYPES.SOY_DIRE]: [
    { label: "NOMBRE Y APELLIDO*", type: "text" },
    { label: "INSTA*", type: "text" },
    { label: "NOMBRE DE PROYECTO/MARCA*", type: "text" },
    { label: "CORREO ELECTRÓNICO*", type: "email" },
  ...
  [CLIENT_TYPES.OTROS]: [
    { label: "NOMBRE Y APELLIDO*", type: "text" },
    { label: "INSTA*", type: "text" },
    { label: "DESCRIBE QUIÉN ERES*", type: "text" },
    { label: "QUÉ QUIERES HACER EN EL ESTUDIO*", type: "text" },
    { label: "CORREO ELECTRÓNICO*", type: "email" },
    { label: "TELÉFONO*", type: "tel" },
  ],
};
